...
def logic(arena_data: dict):
    ...
    if elixir_available >= 1 and deployable_troops:
        cheapest_troop = min(deployable_troops, key=lambda troop: atd[troop].elixir)
        if elixir_available >= atd[cheapest_troop].elixir:
            deploy_list.list_.append((cheapest_troop, (0, 0)))
